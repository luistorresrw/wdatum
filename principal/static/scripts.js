function initMap() {
	...
	$.get(url,function(data){
		for(var i = 0; i < data.length; i ++){
			...
			contentString = '<IMG BORDER="0" height="70" src="/media/'+data[i]["fields"]["foto"]+'" ><br><b>'+data[i]["fields"]["nombre"]+'</b><br><i>'+data[i]["fields"]["posLatitud"]+', '+data[i]["fields"]["posLongitud"]+'</i>';
